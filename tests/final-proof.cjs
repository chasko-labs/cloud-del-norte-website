...
(async () => {
	...
	// Launch meeting
	execSync(
		`curl -s -X POST "https://rwmypxz9z6.execute-api.us-west-2.amazonaws.com/admin/meetings/launch" -H "Authorization: Bearer ${modAuth.IdToken}" -H "Content-Type: application/json" -d '{"title":"Final Proof","roomName":"cloud-del-norte-awsug"}'`,
	);
	...
	await page.screenshot({
		path: "docs/walkthrough/in-conference-proof.png",
		fullPage: true,
	});

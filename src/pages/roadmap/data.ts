...
export const boardColumns: BoardColumn[] = [
  {
    ...
    cards: [
      ...
      { id: 'SCRUM-23', title: 'sign-speak.com pricing/integration for clouddeelnote.org' },
      ...
      { id: 'SCRUM-10', title: 'Book Meow Wolf July 2027 Community Day — Santa Fe' },
    ],
  },
  {
    key: 'todo',
  ...
  },
  {
    ...
    cards: [
      { id: 'SCRUM-2', title: 'UG Leaders: Choose Workshop title & date in March' },

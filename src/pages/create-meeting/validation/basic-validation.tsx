...
type AddErrorField = (fieldName: string, fieldData: FormFieldMetaData) => void;
...
export function useBasicValidation(): UseBasicValidationResult {
	...
	const addErrorField = (key: string, fieldData: FormFieldMetaData) =>
		formFieldErrorRefs.current?.set(key, fieldData);

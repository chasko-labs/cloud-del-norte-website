	...
	return (
		<BasicValidationContext.Consumer>
			{({ isFormSubmitted, addErrorField }) => {
				const wholeSalePriceErrorText =
					isEmptyString(wholeSalePrice) &&
					t("createMeeting.meetingDetails.linkRequired");
				const presenterNameErrorText =
					isEmptyString(presenterName) &&
				...
				return (
					...
					>
						<FormField
							label={t("createMeeting.meetingDetails.pricesLabel")}
							description={t("createMeeting.meetingDetails.pricesDescription")}
						>
								...
								<ColumnLayout columns={2}>
									...
									>
										<Input
											...
											type="text"
											ref={(ref) => {
												addErrorField("wholeSalePrice", {
													isValid: !wholeSalePriceErrorText,
													ref,
												});
											}}
										/>
									...
									>
										<Input
											...
											type="text"
											ref={(ref) => {
												addErrorField("presenterName", {
													isValid: !presenterNameErrorText,
													ref,
												});
											}}
										/>

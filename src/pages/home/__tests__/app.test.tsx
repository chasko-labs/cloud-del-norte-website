	...
	useTranslation: () => ({
		...
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"productionTable.headers.molding": "Molding",
				"qualityTable.headers.name": "Name",
				"qualityTable.headers.strong": "Strong",
				"qualityTable.headers.mild": "Mild",
				"qualityTable.headers.unnoticed": "Unnoticed",
				"userGroupMetrics.communityMembers": "Community Members",
				"userGroupMetrics.fiveStarReviews": "5 Star Reviews",
				"userGroupMetrics.meetupsHeld": "Meetups Held",
				"userGroupMetrics.est": "Est.",
				"pieChart.chartAriaRoleDescription": "Pie chart",
				"pieChart.detailPopoverDismissAriaLabel": "Dismiss details",
				"pieChart.legendAriaLabel": "Legend",
				"pieChart.filterSelectedAriaLabel": "Selected",
				"pieChart.segmentAriaRoleDescription": "Segment",
			};

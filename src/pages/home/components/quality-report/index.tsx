...
const columnDefinitions = (
	...
	{
		header: t("qualityTable.headers.unnoticed"),
		cell: ({ unnoticed }) => unnoticed,
	},
];
...
export default function QualityReport({ notes }: QualityReportProps) {
	...
	return (
		<div className="cdn-card">
			<Container
				header={<Header variant="h2">{t("userGroupHero.header")}</Header>}
			>
				<SpaceBetween size="m">
					<Box
        ...
        About Services Discussed
				...
				{showTastingNotes ? (
					<Modal
						...
						header={t("dashboardPage.groupNotesModal")}
					>
						<Table

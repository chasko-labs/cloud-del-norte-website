...
const RiftRewindDashboard: React.FC = () => {
  ...
  const columnDefinitions = [
    {
      id: 'champion',
      header: t('learning.api.columnChampionName'),
      cell: (item: MatchSummary) => item.champion,
    },
    {
      id: 'matchId',
      header: t('learning.api.columnChampionTitle'),
      cell: (item: MatchSummary) => item.matchId,
    },
    {
      id: 'kills',
      header: t('learning.api.columnAttackPower'),
      cell: (item: MatchSummary) => item.kills,
    },
    {
      id: 'deaths',
      header: t('learning.api.columnDefenseRating'),
      cell: (item: MatchSummary) => item.deaths,
    },
    {
      id: 'assists',
      header: t('learning.api.columnSpeedRating'),
      cell: (item: MatchSummary) => item.assists,
    },
    {
      id: 'result',
      header: t('learning.api.columnTierStatus'),
    ...
    <SpaceBetween direction="vertical" size="l">
      <Container header={<Header variant="h3">{t('learning.api.howRiotAPIRESTful')}</Header>}>
        <SpaceBetween direction="vertical" size="m">
          <Box variant="p">
            {t('learning.api.restIntro')}
          </Box>
          
          <ColumnLayout columns={2} variant="text-grid">
            <Container variant="stacked">
              <Header variant="h3">{t('navigation.uniformInterface')}</Header>
              <Box variant="p">
                {t('learning.api.uniformInterfaceDesc')}<br/>
                <code>GET /contests?year=2024</code><br/>
                {t('learning.api.uniformInterfaceAlwaysReturns')}: <code>[{'{id: "worlds2024", name: "Worlds Championship 2024", status: "completed", winner: "T1"}'}, ...]</code>
              </Box>
            </Container>
            
            <Container variant="stacked">
              <Header variant="h3">{t('navigation.clientServer')}</Header>
              <Box variant="p">
            ...
            <Container variant="stacked">
              <Header variant="h3">{t('navigation.stateless')}</Header>
              <Box variant="p">
            ...
            <Container variant="stacked">
              <Header variant="h3">{t('navigation.cacheable')}</Header>
              <Box variant="p">
            ...
            <Container variant="stacked">
              <Header variant="h3">{t('navigation.layeredSystem')}</Header>
              <Box variant="p">
      ...
      <Container header={<Header variant="h3">{t('learning.api.uniformInterfaceDemonstration')}</Header>}>
        <SpaceBetween direction="vertical" size="s">
          <Box variant="p">
            {t('learning.api.sameHttpMethodDesc')}
          </Box>
          
          <Container variant="stacked">
            <Header variant="h3">{t('learning.api.contestsEndpoint')}</Header>
            <SpaceBetween direction="vertical" size="s">
              <Box variant="p">{t('learning.api.recentTournamentsDesc')}</Box>
              ...
              <Box variant="p">
                <strong>{t('learning.api.responseWeExpect')}</strong><br/>
                <code>{t('learning.api.responseHttpOk')}</code> {t('learning.api.responseWithJsonArray')}<br/>
          ...
          {activeDemo === 'contests' && contests.length > 0 && (
            <Container 
              header={
                <Header 
                  variant="h3" 
                  description={t('learning.api.liveContestDataDesc')}
                >
            ...
            >
              <SpaceBetween direction="vertical" size="s">
                <Box variant="p">
                  ...
                  <code>{t('learning.api.responseHttpOk')}</code> {t('learning.api.withJsonArray')} {contests.length} {t('learning.api.contestObjectsLabel')}
                </Box>
                
                <Box variant="p">
                  <strong>{t('learning.api.dataStructureLabel')}</strong><br/>
                  {t('learning.api.dataStructureDetails')} <code>id</code>, <code>name</code>, <code>status</code>, <code>winner</code><br/>
                  <strong>{t('learning.api.endpointLabel')}</strong> <code>[lambda-id].lambda-url.us-east-2.on.aws/?endpoint=contests</code>
                </Box>
                
                <Table
                  columnDefinitions={[
                    {id: 'name', header: t('learning.api.columnTournament'), cell: (item: Contest) => item.name},
                    {id: 'status', header: t('learning.api.columnStatus'), cell: (item: Contest) => item.status},
                    {id: 'winner', header: t('learning.api.columnWinner'), cell: (item: Contest) => item.winner}
                  ]}
                  items={contests}
                  empty={t('learning.api.noContestsAvailable')}
                />
              </SpaceBetween>
            </Container>
          )}
      ...
      <Container 
        header={
          <Header 
            variant="h3" 
            description={t('learning.api.performanceScoresDesc')}
          >
        ...
        <SpaceBetween direction="vertical" size="s">
          {championsApiDetails && hasTriedLiveData && (
            <Alert 
              ...
              header={t('learning.api.championsApiRequestDetails')}
              dismissible
            ...
            >
              <SpaceBetween direction="vertical" size="s">
                <ColumnLayout columns={2} variant="text-grid">
                  <Box>
                    <Box variant="strong">{t('learning.api.expectedUrlLabel')}</Box>
                    <Box variant="code">{championsApiDetails.expected_url}</Box>
                  </Box>
                  <Box>
                    <Box variant="strong">{t('learning.api.expectedResponseLabel')}</Box>
                ...
                <ColumnLayout columns={2} variant="text-grid">
                  <Box>
                    <Box variant="strong">{t('learning.api.actualStatusLabel')}</Box>
                  ...
                  <Box>
                    <Box variant="strong">{t('learning.api.actualResponseLabel')}</Box>
                ...
                <ColumnLayout columns={2} variant="text-grid">
                  <Box>
                    <Box variant="strong">{t('learning.api.dataSourceLabel')}</Box>
                    <Box>{championsApiDetails.data_source}</Box>
                  </Box>
                  <Box>
                    <Box variant="strong">{t('learning.api.authenticationLabel')}</Box>
                    <Box>{championsApiDetails.authentication}</Box>
                  </Box>
                </ColumnLayout>
                
                <Box>
                  <Box variant="strong">{t('learning.api.responseFormatLabel')}</Box>
          ...
          <Box variant="p">
            <strong>{t('learning.api.columnPerformanceScore')}:</strong> {t('learning.api.performanceScoreExplained')} <strong>{t('learning.api.columnTournamentRecord')}:</strong> {t('learning.api.tournamentRecordDesc')} {selectedYear.value} matches. <strong>{t('learning.api.columnSignatureChampion')}:</strong> {t('learning.api.signatureChampionDesc')}
          </Box>
          ...
          columnDefinitions={[
            {
              id: 'player',
              header: t('learning.api.columnPlayer'),
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              cell: (item: any) => (
                <Box>
            ...
            {
              id: 'champion',
              header: t('learning.api.columnSignatureChampion'),
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              cell: (item: any) => item.championPlayed
            },
            {
              id: 'tournamentRecord',
              header: t('learning.api.columnTournamentRecord'),
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              cell: (item: any) => (
                <Box>
            ...
            {
              id: 'performance',
              header: t('learning.api.columnPerformanceScore'),
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              cell: (item: any) => (
            ...
            {
              id: 'achievement',
              header: t('learning.api.columnAchievement'),
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              cell: (item: any) => (
                <Box>
          ...
          empty={
            <Box textAlign="center">
              ...
              <Box variant="p" padding={{ bottom: 's' }}>
                {t('learning.api.selectYearForData')}
              </Box>
            </Box>
          }
          />
      ...
      {(errorMessage || apiResponse) && hasTriedLiveData && !activeDemo && (
        <Alert 
          ...
          header={dataSource === 'live' ? t('learning.api.apiIntegrationSuccess') : t('learning.api.apiIntegrationWarning')}
          dismissible
        ...
        >
          <SpaceBetween direction="vertical" size="xs">
            {apiResponse && (
              <Box>
                <Box variant="strong">{t('learning.api.responseStatusLabel')}</Box>
                <Box margin={{ left: 's' }}>{apiResponse}</Box>
              </Box>
            )}
            {errorMessage && (
              <Box>
                <Box variant="strong">{t('learning.api.errorDetailsLabel')}</Box>
            ...
            <Box>
              <Box variant="strong">{t('learning.api.lambdaFunctionLabel')}</Box>
      ...
      <Container 
        header={
          ...
          >
            {dataSource === 'live' ? t('learning.api.liveChampionPerformanceData') : t('learning.api.demoChampionPerformanceData')}
          </Header>
        }
      >
        {(errorMessage || championApiResponse || endpointDetails) && (
          ...
          >
            <SpaceBetween direction="vertical" size="s">
              {championApiResponse && (
                <Box>
                  <Box variant="strong">{t('learning.api.dataSourcesLabel')}</Box>
                  <Box margin={{ left: 's' }}>{championApiResponse}</Box>
                </Box>
              )}
              {endpointDetails && (
                <Box>
                  <Box variant="strong">{t('learning.api.apiEndpointsLabel')}</Box>
                  <Box margin={{ left: 's' }}>{endpointDetails}</Box>
                </Box>
              )}
              {errorMessage && (
                <Box>
                  <Box variant="strong">{t('learning.api.issuesLabel')}</Box>
                  <Box margin={{ left: 's' }}>{errorMessage}</Box>
                </Box>
              )}
              <ColumnLayout columns={2} variant="text-grid">
                <Box>
                  <Box variant="strong">{t('learning.api.lambdaEndpointLabel')}</Box>
                  <Box>[lambda-id].lambda-url.us-east-2.on.aws</Box>
                </Box>
                <Box>
                  <Box variant="strong">{t('learning.api.dataFormatLabel')}</Box>
                  <Box>{t('learning.api.dataFormatValue')}</Box>
                </Box>
              </ColumnLayout>
            </SpaceBetween>
          </Alert>
        ...
        <SpaceBetween direction="vertical" size="m">
          <ColumnLayout columns={2} variant="text-grid">
            <Container variant="stacked">
              ...
              <Box variant="p">
                {t('learning.api.dataDragonApi')}<br/>
                {t('learning.api.challengerLeague')}<br/>
                {t('learning.api.championMastery')}<br/>
                {t('learning.api.matchHistory')}
              </Box>
            </Container>
            ...
            <Container variant="stacked">
              ...
              <Box variant="p">
                {t('learning.api.tournamentApi')}<br/>
                {t('learning.api.featuredGames')}<br/>
                {t('learning.api.esportsData')}<br/>
                {t('learning.api.productionKeys')}
              </Box>
            </Container>
          </ColumnLayout>
        ...
        <SpaceBetween direction="vertical" size="l">
          <ColumnLayout columns={2} variant="text-grid">
            <Container variant="stacked">
              ...
              <Box variant="p">
                <strong>{t('learning.api.fromRiotApiLabel')}</strong><br/>
                {t('learning.api.championNamesLore')}<br/>
                {t('learning.api.attackDamageHealth')}<br/>
                {t('learning.api.officialGameBalance')}<br/><br/>
                <strong>{t('learning.api.ourProcessingLabel')}</strong><br/>
                {t('learning.api.tierRankings')}<br/>
                {t('learning.api.displayScaling')}<br/>
                {t('learning.api.performanceCalcs')}
              </Box>
            </Container>
            ...
            <Container variant="stacked">
              ...
              <Box variant="p">
                <strong>{t('learning.api.frontendLabel')}</strong> {t('learning.api.frontendValue')}<br/>
                <strong>{t('learning.api.buildLabel')}</strong> {t('learning.api.buildValue')}<br/>
                <strong>{t('learning.api.hostingLabel')}</strong> {t('learning.api.hostingValue')}<br/>
                <strong>{t('learning.api.apiLabel')}</strong> {t('learning.api.apiValue')}<br/>
                <strong>{t('learning.api.dataLabel')}</strong> {t('learning.api.dataValue')}
              </Box>
            </Container>
          </ColumnLayout>
          ...
          <Container variant="stacked">
            ...
            <ColumnLayout columns={3} variant="text-grid">
              <Box variant="p">
                <strong>{t('learning.api.attackPowerLabel')}</strong><br/>
                <code>{t('learning.api.attackPowerCode')}</code>
              </Box>
              <Box variant="p">
                <strong>{t('learning.api.defenseRatingLabel')}</strong><br/>
                <code>{t('learning.api.defenseRatingCode')}</code>
              </Box>
              <Box variant="p">
                <strong>{t('learning.api.speedRatingLabel')}</strong><br/>
                <code>{t('learning.api.speedRatingCode')}</code>
              </Box>
            </ColumnLayout>
          </Container>
        </SpaceBetween>

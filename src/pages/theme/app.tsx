...
const allPaletteSwatches: SwatchEntry[] = [
  ...
  { name: 'Navy Mid', token: '--cdn-navy-mid', hex: '#000040', note: 'mid navy' },
  { name: 'Espresso', token: '--cdn-gradient-nav-start', hex: '#2c1206', note: 'top nav / espresso' },
  { name: 'Purple Deep', token: '--cdn-purple-deep', hex: '#30006a', note: 'dark mode nav end' },
  { name: 'Purple', token: '--cdn-purple', hex: '#5a1f8a', note: 'primary interactive' },
  { name: 'Violet', token: '--cdn-violet', hex: '#9060f0', note: 'accent + glow' },
  { name: 'Lavender', token: '--cdn-lavender', hex: '#d7c7ee', note: 'light borders / dark text' },
  { name: 'Amber', token: '--cdn-amber', hex: '#8b5a2b', note: 'warm sepia accent' },
  { name: 'Gold', token: '--cdn-gold', hex: '#c9a23f', note: 'emeritus accent' },
  { name: 'AWS Orange', token: '--cdn-aws-orange', hex: '#FF9900', note: 'CTA emphasis' },
  { name: 'Cream', token: '--color-background-container-content-6u8rvp', hex: '#faf7f0', note: 'card surface (light)' },
  { name: 'Indigo', token: '--cdn-elevation-2', hex: '#1a1a4a', note: 'elevation 2 (dark)' },
];
...
function ArticleFadeDemo() {
  ...
  return (
    ...
    >
      <div key={key} className="theme-demo-article-container" aria-hidden="true">
      ...
      <div className="theme-krux-state">
        ...
        <div className="theme-krux-player">
          <div className="theme-krux-player__top">
            {/* skip pill */}
            <button type="button" className="feed-krux__skip" aria-label="skip station">
              &#187;&#187;
            </button>
            {/* label with headphones + station shimmer */}
            <button type="button" className="feed-krux__label" aria-label="krux stream idle">
            ...
            <button type="button" className="feed-krux__btn" aria-label="play krux stream" data-state="idle">
              &#9654;
            </button>
          </div>
          <span className="feed-krux__now-playing">aws builders radio — 24/7 stream</span>
        </div>
      </div>
      ...
      <div className="theme-krux-state">
        ...
        <div className="theme-krux-player">
          <div className="theme-krux-player__top">
            ...
            >
              <span className="feed-krux__headphones feed-krux__headphones--playing" aria-hidden="true">
                &#127911;
              </span>
              <span
                style={{
                  ...
                  fontWeight: 'var(--cdn-weight-medium)' as React.CSSProperties['fontWeight'],
                }}
              >
                KRUX Station
              </span>
            ...
            <button type="button" className="feed-krux__btn" aria-label="stop krux stream" data-state="playing">
              &#9646;&#9646;
            </button>
          </div>
          <span className="feed-krux__now-playing">now playing: builders lab live — track 04</span>
        </div>
      </div>
    </div>
  );
    ...
    <div className="theme-interactive-grid">
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
        <div
          ...
          role="presentation"
          tabIndex={0}
          aria-label="side nav hover demo — hover to see amber accent flash"
        >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6, alignItems: 'flex-start' }}>
        <div
          ...
          style={{
            padding: '12px 16px',
            background: 'linear-gradient(135deg, var(--cdn-gradient-nav-start) 0%, var(--cdn-gradient-nav-end) 100%)',
          }}
          role="presentation"
          aria-label="top nav shimmer — shimmer sweeps automatically"
        >
          <span style={{ color: 'rgba(240,240,240,0.87)', fontSize: 'var(--cdn-text-sm)', letterSpacing: '0.04em' }}>
            cloud del norte
          </span>
        </div>
        <span className="theme-interactive-label">top nav shimmer — cdn-shimmer 4s linear</span>
      </div>

      <div style={{ display: 'flex', flexDirection: 'column', gap: 6, alignItems: 'flex-start' }}>
        <button type="button" className="theme-hover-demo--skip" aria-label="skip button hover demo">
          &#187;&#187; skip
        </button>
        <span className="theme-interactive-label">skip pill hover — scale(1.1) + outer glow</span>
      </div>

      <div style={{ display: 'flex', flexDirection: 'column', gap: 6, alignItems: 'flex-start' }}>
        <span className="theme-badge-pill" role="presentation" tabIndex={0} aria-label="info badge pill">
          info
        </span>
        <span className="theme-interactive-label">
          info badge pill
...
function GlassmorphismDemo() {
  return (
    <SpaceBetween size="l">
      <Box variant="p" fontSize="body-s">
        the .cdn-card class — backdrop-filter blur, gradient surface, animated accent line, warm amber glow (light) /
        violet glow (dark)
      </Box>
      <div className="theme-glass-grid">
        ...
        <div
          style={{
            ...
            boxShadow: '0 8px 24px -6px rgba(0,0,0,0.3), 0 0 20px -8px rgba(144, 96, 240, 0.1)',
          }}
        >
          <SpaceBetween size="xs">
            <Box variant="strong" fontSize="heading-s">
              <span style={{ color: 'var(--cdn-lavender, #d7c7ee)' }}>dark mode glass</span>
            </Box>
            <Box variant="p" fontSize="body-s">
              <span style={{ color: 'rgba(240,240,240,0.6)' }}>navy background + violet glow border</span>
            </Box>
            <Box variant="small" color="text-body-secondary">
    ...
    <SpaceBetween size="m">
      ...
      <div className="theme-type-comparison">
        <div className="theme-type-sample theme-type-sample--antialiased">
          <div className="theme-type-sample__heading">antialiased (cdn default)</div>
        ...
        <div className="theme-type-sample theme-type-sample--default">
          <div className="theme-type-sample__heading">browser default (auto)</div>
          <p className="theme-type-sample__text">{sampleText}</p>
          <Box variant="code" fontSize="body-s">
      ...
      <div className="theme-letter-spacing-row">
        <div className="theme-letter-spacing-row__item">
          <span className="theme-letter-spacing-row__token">body (0.005em)</span>
          <span className="theme-letter-spacing-row__sample" style={{ letterSpacing: '0.005em' }}>
            Cloud Del Norte Meetup
          </span>
        </div>
        <div className="theme-letter-spacing-row__item">
          <span className="theme-letter-spacing-row__token">body-copy (0.01em)</span>
          <span className="theme-letter-spacing-row__sample" style={{ letterSpacing: '0.01em' }}>
            Cloud Del Norte Meetup
          </span>
        </div>
        <div className="theme-letter-spacing-row__item">
          <span className="theme-letter-spacing-row__token">labels (0.04em)</span>
          <span className="theme-letter-spacing-row__sample" style={{ letterSpacing: '0.04em' }}>
            Cloud Del Norte Meetup
          </span>
        </div>
        <div className="theme-letter-spacing-row__item">
          <span className="theme-letter-spacing-row__token">badges (0.06em)</span>
          <span
            className="theme-letter-spacing-row__sample"
            style={{ letterSpacing: '0.06em', textTransform: 'uppercase', fontSize: '0.68rem', fontWeight: 600 }}
          >
            Cloud Del Norte
          </span>
        </div>
...
function AppContent({
  ...
  return (
    <ContentLayout header={<Header variant="h1">{t('themePage.header')}</Header>}>
      <SpaceBetween size="l">
        {/* ── 1. Color palette ── */}
            ...
            <div className="theme-color-grid">
              {allPaletteSwatches.map(s => (
                <div key={s.token} className="theme-color-swatch">
                  ...
                  {s.note && <span className="theme-color-swatch__hex">{s.note}</span>}
                </div>
              ))}
            </div>
          </SpaceBetween>
        ...
        {/* ── 2. Motion & animations ── */}
        <Container header={<Header variant="h2">motion &amp; animations</Header>}>
          <SpaceBetween size="m">
            <Box variant="p" fontSize="body-s">
              live running demos of every animation in the cdn vocabulary. toggle flip and article fade are clickable to
              replay. all animations pause under prefers-reduced-motion.
            </Box>
            <Grid
              gridDefinition={[
                { colspan: { default: 12, xs: 6, s: 4, m: 3 } },
        ...
        <Container header={<Header variant="h2">radio player widget</Header>}>
          <SpaceBetween size="m">
            <Box variant="p" fontSize="body-s">
              full KruxPlayer widget in idle and playing states. idle: periodic station shimmer + rotating glass ring.
              playing: pulsing play button + headphone bob + steady violet text.
            </Box>
            <KruxWidgetDemo />
          </SpaceBetween>
        </Container>
        ...
        <Container header={<Header variant="h2">glassmorphism &amp; surface patterns</Header>}>
          <GlassmorphismDemo />
        </Container>

	...
	it("renders Spanish strings when locale is mx", () => {
		...
		mockTranslation.t = (key: string) => {
			const spanishMap: Record<string, string> = {
				...
				"maintenanceCalendar.description":
					"Rastrea los calendarios de versiones LTS y lanzamientos para tecnologías cloud-native.",
				...
				"maintenanceCalendar.tableHeaders.mostRecentRelease":
					"Lanzamiento más reciente",
				"maintenanceCalendar.tableHeaders.projectedNextRelease":
					"Próximo lanzamiento proyectado",
				"maintenanceCalendar.tableHeaders.projectedNextLTS":
					"Próximo LTS proyectado",
			};
	...
	it("renders English strings when locale is us", () => {
		...
		mockTranslation.t = (key: string) => {
			const englishMap: Record<string, string> = {
				...
				"maintenanceCalendar.description":
					"Track LTS and release schedules across cloud-native technologies.",

import type { ReleaseEntry, TechCalendar } from "../types";
...
export function checkStaleManual(
	...
	const ageDays =
		(now.getTime() - new Date(entry.lastManualUpdate).getTime()) / 86400000;
...
export function filterStableReleases<
	T extends { prerelease: boolean; draft: boolean },
>(releases: T[]): T[] {
